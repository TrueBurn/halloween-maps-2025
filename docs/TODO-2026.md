...
### 🔴 CRITICAL: PostHog Event Management
...
4. **Event Audit**
   ...
   - [ ] Keep only high-value events:
     ...
     - ✅ Location clicks (essential)
     - ✅ Directions requests (essential)
     - ✅ GPS permission (essential)
     - ❓ Filter applications (evaluate - may be too frequent)
     - ❓ Map interactions (evaluate - may need sampling)
     - ❓ User location updates (evaluate - reduce frequency)
